...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [
                ("15.4", dt(2024, 9, 29, 0, 0)),
                ("15.3", dt(2024, 9, 30, 0, 0)),
                ("15.2", dt(2024, 3, 31, 0, 0)),
                ("14.9", dt(2024, 9, 30, 0, 0)),
                ("14.8", dt(2024, 9, 30, 0, 0)),
                ("14.7", dt(2024, 3, 31, 0, 0)),
                ("14.6", dt(2024, 3, 31, 0, 0)),
                ("14.5", dt(2024, 3, 31, 0, 0)),
                ("14.4", dt(2024, 3, 31, 0, 0)),
                ("14.3", dt(2024, 3, 31, 0, 0)),
                ("13.12", dt(2024, 9, 30, 0, 0)),
                ("13.11", dt(2024, 9, 30, 0, 0)),
                ("13.10", dt(2024, 3, 31, 0, 0)),
                ("13.9", dt(2024, 3, 31, 0, 0)),
                ("13.8", dt(2024, 3, 31, 0, 0)),
                ("13.7", dt(2024, 3, 31, 0, 0)),
                ("12.16", dt(2024, 9, 30, 0, 0)),
                ("12.15", dt(2024, 9, 30, 0, 0)),
                ("12.14", dt(2024, 3, 31, 0, 0)),
                ("12.13", dt(2024, 3, 31, 0, 0)),
                ("12.12", dt(2024, 3, 31, 0, 0)),
                ("12.11", dt(2024, 3, 31, 0, 0)),
                ("11.21", dt(2023, 11, 30, 0, 0)),
                ("11.20", dt(2023, 11, 30, 0, 0)),
                ("11.19", dt(2023, 11, 30, 0, 0)),
                ("11.18", dt(2023, 11, 30, 0, 0)),
                ("11.17", dt(2023, 11, 30, 0, 0)),
                ("11.16", dt(2023, 11, 30, 0, 0)),
            ],
        ),
        (
            "mysql-release-calendar.html",
            [
                ("8.0.34", dt(2024, 9, 29, 0, 0)),
                ("8.0.33", dt(2024, 9, 30, 0, 0)),
                ("8.0.32", dt(2024, 3, 31, 0, 0)),
                ("8.0.31", dt(2024, 3, 31, 0, 0)),
                ("8.0.30", dt(2023, 9, 30, 0, 0)),
                ("8.0.28", dt(2024, 3, 31, 0, 0)),
                ("5.7.43", dt(2023, 12, 31, 0, 0)),
                ("5.7.42", dt(2023, 12, 31, 0, 0)),
                ("5.7.41", dt(2023, 12, 31, 0, 0)),
                ("5.7.40", dt(2023, 12, 31, 0, 0)),
                ("5.7.39", dt(2023, 12, 31, 0, 0)),
                ("5.7.38", dt(2023, 12, 31, 0, 0)),
                ("5.7.37", dt(2023, 12, 31, 0, 0)),
            ],
        ),
    ],
)
