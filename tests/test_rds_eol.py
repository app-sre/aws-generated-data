...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [
                ("8.4", dt(2032, 7, 31, 0, 0)),
                ("8.0", dt(2029, 7, 31, 0, 0)),
                ("5.7*", dt(2027, 2, 28, 0, 0)),
                ...
                ("5.7.44-RDS.20250213*", dt(2026, 9, 30, 0, 0)),
                ("5.7.44-RDS.20250103*", dt(2026, 9, 30, 0, 0)),
                ("5.7.44-RDS.20240808*", dt(2025, 9, 30, 0, 0)),
                ("5.7.44-RDS.20240529*", dt(2025, 9, 30, 0, 0)),
                ("5.7.44-RDS.20240408*", dt(2025, 9, 30, 0, 0))
            ],
        ),
        (
            "aurora-postgresql-release-calendar.html",
            [
                ("16.2", dt(2025, 5, 31, 0, 0)),
                ("16.1", dt(2025, 5, 31, 0, 0)),
                ("15.6", dt(2025, 5, 31, 0, 0)),
                ("15.5", dt(2025, 2, 28, 0, 0)),
                ("15.4", dt(2025, 2, 28, 0, 0)),
                ("15.3", dt(2025, 2, 28, 0, 0)),
                ("15.2", dt(2024, 9, 30, 0, 0)),
                ("15.1", dt(2024, 9, 30, 0, 0)),
                ("14.11", dt(2025, 5, 31, 0, 0)),
                ("14.10", dt(2025, 2, 28, 0, 0)),
                ("14.9", dt(2025, 2, 28, 0, 0)),
                ("14.8", dt(2025, 2, 28, 0, 0)),
                ("14.7", dt(2024, 9, 30, 0, 0)),
                ("14.6 (LTS)", dt(2027, 2, 28, 0, 0)),
                ("14.5", dt(2024, 9, 30, 0, 0)),
                ("14.4", dt(2024, 9, 30, 0, 0)),
                ("14.3", dt(2024, 9, 30, 0, 0)),
                ("13.14", dt(2025, 2, 28, 0, 0)),
                ("13.13", dt(2025, 2, 28, 0, 0)),
                ("13.12", dt(2025, 2, 28, 0, 0)),
                ("13.11", dt(2025, 2, 28, 0, 0)),
                ("13.10", dt(2024, 9, 30, 0, 0)),
                ("13.9 (LTS)", dt(2026, 2, 28, 0, 0)),
                ("13.8", dt(2024, 9, 30, 0, 0)),
                ("13.7", dt(2024, 9, 30, 0, 0)),
                ("12.18", dt(2025, 2, 28, 0, 0)),
                ("12.17", dt(2025, 2, 28, 0, 0)),
                ("12.16", dt(2025, 2, 28, 0, 0)),
                ("12.15", dt(2025, 2, 28, 0, 0)),
                ("12.14", dt(2024, 9, 30, 0, 0)),
                ("12.13", dt(2024, 9, 30, 0, 0)),
                ("12.12", dt(2024, 9, 30, 0, 0)),
                ("12.11", dt(2024, 9, 30, 0, 0)),
